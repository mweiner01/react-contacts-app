...
const Contact = ({ contact, onDelete, onEdit }) => {
    return (
        <div className="p-4 rounded border border-gray-300 shadow">
            ...
            <div className="flex my-4 gap-x-4">
                <div className="">
                    <button onClick={() => onEdit(contact)} className="py-1 text-gray-800 px-4 bg-gray-200 hover:bg-gray-300">Bearbeiten</button>
                </div>
                <div>
